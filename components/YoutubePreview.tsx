...
export const YoutubePreview: React.FC<YoutubePreviewProps> = ({ title }) => {
  ...
  return (
    <div className="flex flex-col gap-4 sticky top-6 animate-in fade-in duration-700">
      ...
      <div className={`
        bg-[#0f0f0f] border border-white/10 rounded-xl overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] antialiased group/card
